...
<input type="hidden" id="chat_whatsapp" value="01117615935" />
<div class="whatsapp-chat">
    <div id='whatsapp-chat' class='hide'>
        <div class='header-chat'>
            <div class='head-home'>
                <div class='info-avatar'>
                    <img src="{{ asset('/website_assets/images/homePage/2.png') }}" alt="profile picture">
                </div>
        ...
        <div class='start-chat'>
            ...
            <div class='blanter-msg'>
                <textarea id='chat-input' placeholder='@if (LaravelLocalization::getCurrentLocale() === 'en') Write a response @else أكتب تعليق @endif' maxlength='120' row='1'></textarea>
        ...
        <a class='close-chat my-1' href='javascript:void(0);'>×</a>
    </div>
</div>

<a class='blantershow-chat' href="https://{{ $comFooter->chat_whatsapp }}" target="_blank" title='Show Chat'>
