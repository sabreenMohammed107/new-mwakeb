@extends('layout.website.layout', ['Company' => $Company, 'title' => 'مواكب | سياسة الاسترجاع'])
...
@section('bottom-header')
    <x-website.header.general title="سياسة الاسترجاع" :breadcrumb="$BreadCrumb" current="" />
@endsection
@section('content')
    <section class="investigtion">
        ...
        <section class="container">
            ...
            <div class="container__content">
                <div class="mt-1">
                    ...
                    <p class="px-2">Mwakeb.Com reserves the right to change and modify these terms and conditions at any
                        time. Changes will be effective as soon as they are published on the Mwakeb.Com website </p>
                </div>
                ...
                <div class="mt-5">
                    ...
                    <p class="px-2">It is the responsibility of all Mwakeb.Com members to ensure they have entered a
                ...
                <div class="mt-5">
                    ...
                    <p class="px-2">It is the responsibility of the Mwakeb.Com member making the booking to ensure that
                        ...
                        While Mwakeb.Com undertake to ensure that your clients requested room type and smoking preference
                        is available, Mwakeb.Com cannot guarantee the actual bedding make-up of the room. These requests
                        are sent to the hotel and are subject to availability.
                        Mwakeb.Com try to ensure that the hotel provides the room type(s) booked, however there may be
                ...
                <div class="mt-5">
                    ...
                    <p class="px-2">Star ratings aim to give a general overview of the quality of the hotel and
                        ...
                        hotel. Mwakeb.Com are not responsible for the hotel categories and * ratings as these have been
                ...
                <div class="mt-5">
                    ...
                    <p class="px-2">Currency exchange rates generally change on daily basis depending on the fluctuations
                        in the market. Mwakeb.Com reserve the right to update room rates displayed on the website
                        ...
                        All rates are valid for the leisure market only. Mwakeb.Com will not accept responsibility for any
                ...
                <div class="mt-5">
                    ...
                    <p class="px-2">Our company name will appear as Mwakeb.Com LLC on the credit card statement of the
                        credit card used to make the booking. If a Mwakeb.Com member has used their clients credit card to
                        make the hotel booking then it is the responsibility of the Mwakeb.Com member to inform their
                        customer of this important information in order to avoid any misunderstandings.
                        Mwakeb.Com reserve the right to correct any pricing or displayed errors and/or omissions. This
                ...
                <div class="mt-5">
                    ...
                    <p class="px-2">Not all of the hotel rates are displayed on the Mwakeb.Com website are applicable
                ...
                <div class="mt-5">
                    ...
                    <p class="px-2">The majority of credit card providers charge some sort of an International Transaction
                        ...
                        reside in. Please note that the charge has not been passed on by Mwakeb.Com and that Mwakeb.Com
                        ...
                        directly. This is typically $10 to $20 a room a night. Mwakeb.Com is not responsible for resort
                ...
                <div class="mt-5">
                    ...
                    <p class="px-2">Mwakeb.Com has no control over any extra charges that a hotel may decide to their
                        implement for guest room incidentals such as air conditioning, safe, mini fridge, hire of television
                        remote etc... Any such charges must be paid direct to the hotel and Mwakeb.Com cannot be held
                        responsible for any incidental charges passed on by the hotel.
                        Likewise Mwakeb.Com has no control over any fees that a hotel may pass on for luggage storage,
                        ...
                        informed about Gala dinner supplements and Mwakeb.Com cannot be held responsible for any gala
                ...
                <div class="mt-5">
                    ...
                    <p class="px-2">We prefer that all cancellations and amendments are made on the Mwakeb.Com website.
                        Alternatively you can contact the Mwakeb.Com Reservation Team via e-mail or fax before the
                        cancellation deadline for that specific booking/hotel. We do not accept cancellations or amendments
                        over the telephone.
                        Mwakeb.Com will not be bound by nor responsible for any changes and cancellations made directly
                        with the hotel.
                        ...
                        different cancellation policy of which you will be informed as soon as Mwakeb.Com are notified.
                        ...
                        which we will inform you about as soon as Mwakeb.Com are notified. Generally these restrictions
                ...
                <div class="mt-5">
                    ...
                    <p class="px-2">To protect your Mwakeb.Com account - When a booking has been made by a 3rd party,
                        Mwakeb.Com reserves the right to request proof of ID from the credit cardholder as well as a
                ...
                <div class="mt-5">
                    ...
                    <p class="px-2">If the original hotel booked is closed, over booked or has maintenance problems and
                        ...
                        finding you alternate accommodation of a similar standard. Where we have prior notice Mwakeb.Com
                        will contact you by e.mail.
                        Mwakeb.Com accepts no liability for any losses or costs that might occur as a result of
                        ...
                        Mwakeb.Com reserve the right to cancel any FIT booking made for a group or if we consider them to
                        have been made for the purpose of holding space for future sale. Please submit your group request
                        using the Mwakeb.Com group page.
                    ...
                    <div class="mt-5">
                        ...
                        <p class="px-2">The hotels with “REQUEST” button and bookings with On Request Processing status
                            means that the hotel does not have any available allotment, however Mwakeb.Com will contact
                            ...
                            hotel with Instant confirmation. Depending upon when a new search is made on Mwakeb.Com
                        ...
                        <div class="mt-5">
                            ...
                            <p class="px-2">Hotel information: While Mwakeb.Com strives to present hotel information as
                                ...
                                beyond our control. Mwakeb.Com cannot accept responsibility for any disturbance or
                                ...
                                etc...Any such charges must be paid direct to the hotel and Mwakeb.Com cannot be held
                                responsible for any incidental charges passed on by the hotel.
                                ...
                                All of the hotels on the Mwakeb.Com website require one of the guests to be at least 18
                        ...
                        <div class="mt-5">
                            ...
                            <p class="px-2">Maps are provided for information purposes only. While Mwakeb.Com strives
                        ...
                        <div class="mt-5">
                            ...
                            <p class="px-2">Any complaint which cannot be resolved at the hotel must be notified to us by
                                logging into your Mwakeb.Com system and selecting the message category 'Complaint'. All
                                ...
                                Complaints relating to hotel services will be forwarded by Mwakeb.Com to the relevant
                                party.
                        ...
                        <div class="mt-5">
                            ...
                            <p class="px-2">
                            <ul>
                                <li>Mwakeb.Com will not be obliged to request any visa documents from the hotel for any
                                    bookings which have not been paid for in full.</li>
                                <li>Mwakeb.Com will request these visa documents from the hotel upon your acceptance of a
                                    10Eur charge in the event that you cancel the booking.</li>
                                <li>Mwakeb.Com will do the best to accomodate your request but it is not guaranteed that
                                    the hotel will respond to your visa document request.</li>
                                <li>Mwakeb.Com has no control over any charges that a hotel may implement for visa support
                                    documents.</li>
                                <li>In the event that a hotel implements charges for visa support documents, Mwakeb.Com
                        ...
                        <div class="mt-5">
                            ...
                            <p class="px-2">Promotions are offered in good faith only. Some promotions are more popular
                                than others in which case the rooms featured will be sold out much quicker. Mwakeb.Com
                        ...
                        <div class="mt-5">
                            ...
                            <p class="px-2">Telephone calls to Mwakeb.Com may be recorded to enable us to monitor and
                                improve our services.
                                Please contact us at info@Mwakeb.Com if you do not want to receive any promotional
                                e.mails/ Newsletters or special deals.
                                Mwakeb.Com shall not be liable for any failure in service relating from uncontrollable
                                ...
                                affected by the climate and weather conditions. Mwakeb.Com is not liable for the practices
                        ...
                        <div class="mt-5">
                            ...
                            <ol>
                                ...
                                <li>Mwakeb.Com will not assume any responsibility in omissions and typo errors which may
                        ...
                        <div class="mt-5">
                            <p class="px-2">
                                <strong> IMPORTANT - </strong> When the Mwakeb.Com member has completed the booking
                                ...
                                Use of the Mwakeb.Com website is subject to your acceptance of our terms and conditions.
        ...
        <div class="container__content">
            <div class="mt-1">
                ...
                <p class="px-2">Mwakeb.Com تحتفظ لنفسها بالحق في تغيير وتعديل هذه الشروط والأحكام في أي وقت. ستكون التغييرات سارية بمجرد نشرها على موقع Mwakeb.Com.</p>
            </div>
            ...
            <div class="mt-5">
                ...
                <p class="px-2">تقع على عاتق جميع أعضاء Mwakeb.Com مسؤولية التأكد من إدخالهم لعنوان بريد إلكتروني صحيح. إذا تم إرسال بريدنا الإلكتروني إلى مجلد البريد غير المهم أو المهمل، فيمكنك منع حدوث ذلك مرة أخرى عن طريق فتح بريدنا الإلكتروني والنقر على زر "ليس بريدًا عشوائيًا" أو "هذا ليس بريدًا عشوائيًا". </p>
            </div>
            ...
            <div class="mt-5">
                ...
                <p class="px-2">تقع على عاتق عضو Mwakeb.Com الذي يقوم بالحجز مسؤولية التأكد من أن نوع الغرفة المحجوزة سيكون مناسبًا للحفلة التي تسافر. إذا حضر عدد أكبر من الأشخاص في الفندق أكثر مما يمكن للغرفة أن تستوعبه، فسيكون للفندق حق عدم قبول الحجز وفي هذه الحالة لن يتم استرداد أي مبلغ.
                    بينما يتعهد Mwakeb.Com بضمان أن يطلب عملاؤك نوع الغرفة وتفضيلات التدخين المتاحة، لا يمكن لـ Mwakeb.Com ضمان تكوين الفراش الفعلي للغرفة. يتم إرسال هذه الطلبات إلى الفندق وهي رهن بالتوافر.
                    يحاول Mwakeb.Com التأكد من أن الفندق يوفر نوع (أنواع) الغرف المحجوزة، ولكن قد تكون هناك مناسبات عندما يتم تخصيص غرفة مزدوجة أو غرفة مزدوجة بدلاً من غرفة مزدوجة بدلاً من غرفة مزدوجة. يرجى العلم أن غالبية الفنادق الأوروبية توفر سريرين مفردين مدمجين معًا لتكوين سرير مزدوج. بينما يتم إعادة توجيه جميع تفضيلات نوع الغرفة إلى الفندق، يتم تخصيص الغرف بواسطة الفندق ويخضع للتوافر في وقت تسجيل الوصول.
                    فئات الفنادق / التصنيف والتصنيفات المحلية
                    تهدف تصنيفات النجوم إلى إعطاء لمحة عامة عن جودة الفندق والمستوى التقريبي للمرافق والخدمات والمرافق المتاحة. ومع ذلك، فإن نظام التصنيف هذا يختلف من بلد إلى آخر. على سبيل المثال، لن يكون فندق 5 نجوم في بانكوك هو نفسه فندق 5 نجوم في لندن. Mwakeb.Com ليست مسؤولة عن فئات الفنادق والتقييمات * حيث تم توفيرها لنا وقبولها بحسن نية.
            ...
            <div class="mt-5">
                ...
                <p class="px-2">تتغير أسعار صرف العملات بشكل عام على أساس يومي اعتمادًا على تقلبات السوق. يحتفظ Mwakeb.Com بالحق في تحديث أسعار الغرف المعروضة على موقع الويب وفقًا لتقلبات السوق.
                    ...
                    جميع الأسعار صالحة لسوق الترفيه فقط. لن يقبل Mwakeb.Com المسؤولية عن أي حجز إذا أصبح معروفًا أن العميل لا يسافر لأغراض الترفيه. قد ترفض الفنادق احترام سعر العقد الخاص بنا وفرض سعر الرف على العملاء مباشرة.
                    ...
                    الأهمية
                    سيظهر اسم شركتنا باسم Mwakeb.Com LLC في بيان بطاقة الائتمان الخاصة ببطاقة الائتمان المستخدمة في إجراء الحجز. إذا استخدم عضو Mwakeb.Com بطاقة ائتمان عملائه لإجراء حجز الفندق، فمن مسؤولية عضو Mwakeb.Com إبلاغ عملائه بهذه المعلومات المهمة لتجنب أي سوء فهم.
                    يحتفظ Mwakeb.Com بالحق في تصحيح أي أسعار أو أخطاء و / أو سهو معروض. يتضمن ذلك الأخطاء و / أو السهو التي تم إدخالها من قبل صاحب فندق أو وكيل محلي. في حالة وجود خطأ في السعر و / أو إغفال، سوف نعرض عليك الاختيار بين الاحتفاظ بالحجز بالأسعار الصحيحة، أو إلغاء الحجز أو حسب التوافر، سنقدم لك فندقًا بديلاً مناسبًا.
                     </p>
            </div>
            ...
            <div class="mt-5">
                ...
                <p class="px-2">  لا يتم عرض جميع أسعار الفنادق على موقع Mwakeb.Com الإلكتروني المطبقة على السوق المحلي. بالإضافة إلى ذلك، قد تتأثر بعض الأسواق الأخرى وفي مثل هذه الحالات يحق للفندق تغيير الأسعار دون إشعار مسبق.
            ...
            <div class="mt-5">
                ...
                <p class="px-2">يتقاضى غالبية مزودي بطاقات الائتمان نوعًا من رسوم المعاملات الدولية. يمكن أن يصل هذا إلى 3 ٪ على الرغم من أن Capital One لا يفرض رسومًا خاصة به فحسب، بل يأكل أيضًا رسوم 1 ٪ التي تفرضها Visa أو MasterCard. يتم تمرير هذه الرسوم من قبل موفري بطاقات ائتمان معينين لأنه تمت معالجة رسوم حجزك خارج البلد الذي تقيم فيه. يرجى ملاحظة أن Mwakeb.Com لم يتم تمرير هذه الرسوم وأنه لا يمكن حجز Mwakeb.Com مسؤول عن أي رسوم معاملات دولية تفرضها جهة إصدار بطاقة الائتمان الخاصة بك أو لعملائك.
                    تفرض بعض الفنادق، خاصة في الولايات المتحدة الأمريكية، رسوم منتجع يجب دفعها للفندق مباشرةً. هذا عادة ما يكون من 10 دولارات إلى 20 دولارًا للغرفة في الليلة. Mwakeb.Com غير مسؤول عن رسوم المنتجع وليس له سيطرة على تنفيذها.
                    رسوم إضافية من قبل الفندق
                    لا يتحكم Mwakeb.Com في أي رسوم إضافية قد يقرر الفندق تنفيذها لتغطية نفقات غرفة الضيوف الطارئة مثل تكييف الهواء، وخزنة، وثلاجة صغيرة، واستئجار جهاز التحكم عن بعد في التلفزيون، وما إلى ذلك ... يجب دفع أي رسوم من هذا القبيل مباشرة إلى الفندق و Mwakeb.Com لا يمكن أن يكون مسؤولاً عن أي رسوم عرضية يفرضها الفندق.
                    وبالمثل، فإن Mwakeb.Com لا يتحكم في أي رسوم قد يفرضها الفندق على تخزين الأمتعة، والساونا، واستخدام المنتجع الصحي وحمام السباحة، ورسوم مواقف السيارات وما إلى ذلك.
                    خلال موسم الأعياد، وخاصة عيد الميلاد ورأس السنة الجديدة، هناك فنادق تفرض حفلًا إلزاميًا ويجب على الضيوف دفع أي رسوم إضافية مقابل حفل العشاء. لا يتم إبلاغ شركتنا دائمًا بمكملات حفل العشاء ولا يمكن تحميل Mwakeb.Com المسؤولية عن أي مكملات احتفالية ينقلها الفندق.
            ...
            <div class="mt-5">
                ...
                <p class="px-2">لا يتحكم Mwakeb.Com في أي رسوم إضافية قد يقرر الفندق تنفيذها لتغطية نفقات غرفة الضيوف الطارئة مثل تكييف الهواء، وخزنة، وثلاجة صغيرة، واستئجار جهاز التحكم عن بعد في التلفزيون، وما إلى ذلك ... يجب دفع أي رسوم من هذا القبيل مباشرة إلى الفندق و Mwakeb.Com لا يمكن أن يكون مسؤولاً عن أي رسوم عرضية يفرضها الفندق.
                    وبالمثل، فإن Mwakeb.Com لا يتحكم في أي رسوم قد يفرضها الفندق على تخزين الأمتعة، والساونا، واستخدام المنتجع الصحي وحمام السباحة، ورسوم مواقف السيارات وما إلى ذلك.
                    خلال موسم الأعياد، وخاصة عيد الميلاد ورأس السنة الجديدة، هناك فنادق تفرض حفلًا إلزاميًا ويجب على الضيوف دفع أي رسوم إضافية مقابل حفل العشاء. لا يتم إبلاغ شركتنا دائمًا بمكملات حفل العشاء ولا يمكن تحميل Mwakeb.Com المسؤولية عن أي مكملات احتفالية ينقلها الفندق.
            ...
            <div class="mt-5">
                ...
                <p class="px-2">نفضل أن تتم جميع الإلغاءات والتعديلات على موقع Mwakeb.Com. بدلاً من ذلك، يمكنك الاتصال بفريق الحجز Mwakeb.Com عبر البريد الإلكتروني أو الفاكس قبل الموعد النهائي للإلغاء لهذا الحجز / الفندق المحدد. لا نقبل الإلغاءات أو التعديلات عبر الهاتف.
                    Mwakeb.Com لن يكون ملزمًا أو مسؤولاً عن أي تغييرات وإلغاءات تتم مباشرة مع الفندق.
                    ...
                    خلال فترات الأحداث الخاصة وتواريخ معينة والحجوزات المبكرة، قد يمر الفندق بسياسة إلغاء مختلفة سيتم إبلاغك بها بمجرد إخطار Mwakeb.Com.
                    في حالات معينة، لا يُسمح بتغيير الاسم وقد يلزم إلغاء الحجز وإعادة الحجز. في هذه الحالة قد يتم تطبيق معدلات جديدة.
                    أي حجز يقدم ليالي مجانية أو مدخرات للحجز المبكر يخضع لقيود معينة سنبلغك بها بمجرد إخطار Mwakeb.Com. بشكل عام هذه القيود هي؛ لا تغيير في الاسم ولا تمديد أو تقليل الليالي. إذا كنت قد حجزت إقامة تشمل ليلة واحدة مجانًا وقرر عميلك الإلغاء - لن يتم استرداد قيمة الليلة المجانية لأنها مجانية.
            ...
            <div class="mt-5">
                ...
                <p class="px-2">لحماية حساب Mwakeb.Com الخاص بك - عندما يتم إجراء حجز من قبل طرف ثالث، تحتفظ Mwakeb.Com بالحق في طلب إثبات الهوية من حامل بطاقة الائتمان وكذلك نموذج تفويض موقع.
                    هذا الإجراء الأمني لا يسبب أي إزعاج ولكن فقط لحماية حامل بطاقة الائتمان من أي إساءة استخدام لبطاقة الائتمان.
                    نقل عملائك
                    إذا كان الفندق الأصلي المحجوز مغلقًا أو تم حجزه بشكل زائد أو به مشاكل في الصيانة و / أو لا يمكنه توفير الغرفة (الغرف) المحجوزة. أنت تقبل أن يكون صاحب الفندق أو المورد مسؤولاً عن إيجاد سكن بديل لك من نفس المستوى. عندما يكون لدينا إشعار مسبق، سوف يتصل بك Mwakeb.Com عبر البريد الإلكتروني.
                    Mwakeb.Com لا يتحمل أي مسؤولية عن أي خسائر أو تكاليف قد تحدث نتيجة لإعادة الموقع لأن هذا خارج عن سيطرتنا تمامًا.
                    يعتبر الحجز بمثابة حجز جماعي عندما يكون هناك 10 أشخاص أو أكثر مسافرون. يحتفظ Mwakeb.Com بالحق في إلغاء أي حجز FIT تم إجراؤه لمجموعة أو إذا اعتبرنا أنه تم لغرض الاحتفاظ بمساحة للبيع في المستقبل. يرجى تقديم طلب مجموعتك باستخدام صفحة مجموعة Mwakeb.Com.
                    عند طلب الحجوزات
                    الفنادق التي بها زر "طلب" والحجوزات ذات حالة المعالجة عند الطلب تعني أن الفندق ليس لديه أي تخصيص متاح، ومع ذلك سيتصل Mwakeb.Com بالفندق لطلب مساحة إضافية.

                    يرجى العلم أنه في حالات نادرة جدًا، قد يتغير التوافر في الفندق حتى وقت إكمال الحجز وقد تتحول الحالة النهائية إلى عند معالجة الطلب. في هذه الحالات، يرجى عدم محاولة حجز نفس الفندق مرة أخرى. سيتم إبلاغك في غضون 48 ساعة إذا تم تأكيد حجزك أو رفضه. إذا كان من الممكن تأكيد الفندق بسعر مختلف، فسيتم إبلاغك بذلك. يرجى الأخذ في الاعتبار أنه قد لا يتم ضمان التأكيد وأن الفنادق لها الحق في رفض الحجوزات عند الطلب. إذا كان طلب الإقامة الخاص بك عاجلاً، فمن المقترح أن تختار فندقًا بتأكيد فوري. اعتمادًا على وقت إجراء بحث جديد على نظام Mwakeb.Com ، قد ترى نفس الفندق يظهر مرة أخرى. هذا لأن المساحة ربما أصبحت متاحة على الرغم من أن معدلاتها مختلفة عن وقت تقديم الطلب الأولي.
            ...
            <div class="mt-5">
                ...
                <p class="px-2">معلومات الفندق: بينما يسعى Mwakeb.Com جاهدًا لتقديم معلومات الفندق بأكبر قدر ممكن من الدقة، فإننا لسنا مسؤولين عن دقة هذه المعلومات أو عن أي مرافق قد تكون أو لا تكون متاحة في الفندق أثناء إقامة العميل أو غير مناسبة لك الأذواق والتفضيلات الفردية للعميل.
                    تعتبر إعادة الديكور / التجديدات والصيانة ضرورية لصيانة الفندق ويمكن أن تتم دون سابق إنذار، ومع ذلك سيحاول صاحب الفندق تقليل الإزعاج إلى الحد الأدنى. يمكن توقع آثار الاهتراء العادي في فندق وهي خارجة عن إرادتنا. لا يمكن لـ Mwakeb.Com قبول المسؤولية عن أي إزعاج أو إزعاج لعميلك خارج نطاق سيطرة أصحاب الفنادق ولا عن الحوادث أو الخسارة في الفندق بسبب إدارة الفندق أو الموظفين.
                    ليس لدينا أي سيطرة على أي رسوم إضافية قد يقرر الفندق تنفيذها لنفقات غرف النزلاء مثل تكييف الهواء، وخزنة آمنة، وثلاجة صغيرة، واستئجار جهاز التحكم عن بعد في التلفزيون، وما إلى ذلك ... يجب دفع أي رسوم من هذا القبيل مباشرةً إلى الفندق و Mwakeb.Com لا يمكن أن يكون مسؤولاً عن أي رسوم عرضية يفرضها الفندق.
                    ...
                    تتطلب جميع الفنادق الموجودة على موقع Mwakeb.Com ألا يقل عمر أحد الضيوف عن 18 عامًا. في بعض الولايات الأمريكية توجد حدود عمرية أعلى. إذا كنت قد حجزت فندقًا في الولايات المتحدة وكان عمر المسافرين أقل من 25 عامًا، فيرجى الاتصال بالفندق مباشرةً للحصول على توضيح.
            ...
            <div class="mt-5">
                ...
                <p class="px-2">يجب إخطارنا بأي شكوى لا يمكن حلها في الفندق عن طريق تسجيل الدخول إلى نظام Mwakeb.Com الخاص بك واختيار فئة الرسالة "شكوى". يجب إخطارنا بجميع الشكاوى في غضون 20 يومًا من تاريخ المغادرة.
                    يجب أيضًا تقديم نسخة من الشكوى إلى مدير الفندق وتوقيعها. سيتم إرسال الشكاوى المتعلقة بالخدمات الفندقية بواسطة Mwakeb.Com إلى الطرف ذي الصلة.
            ...
            <div class="mt-5">
                ...
                <p class="px-2">
                    - لن يكون Mwakeb.Com ملزمًا بطلب أي وثائق تأشيرة من الفندق لأي حجوزات لم يتم دفع ثمنها بالكامل.
                    - سيطلب Mwakeb.Com مستندات التأشيرة هذه من الفندق عند موافقتك على رسوم 10Eur في حالة إلغاء الحجز.
                    - سوف يبذل Mwakeb.Com قصارى جهده لتلبية طلبك ولكن ليس من المضمون أن يستجيب الفندق لطلب مستند التأشيرة الخاص بك.
                    - لا يتحكم Mwakeb.Com في أي رسوم قد يفرضها الفندق على مستندات دعم التأشيرة.
                    - في حالة قيام فندق بفرض رسوم على مستندات دعم التأشيرة ، يتوقع Mwakeb.Com أن تقوم الوكالة بتسديد الدفعة ذات الصلة مباشرة إلى الفندق.
                    الترقيات والأسعار الترويجية
                    يتم تقديم العروض الترويجية بحسن نية فقط. بعض العروض الترويجية أكثر شيوعًا من غيرها وفي هذه الحالة سيتم بيع الغرف المعروضة بشكل أسرع. يحتفظ Mwakeb.Com بالحق في تعديل أو تغيير أي ترويج أو عرض في أي وقت دون إشعار. يرجى البحث عن التواريخ المطلوبة للحصول على أحدث الأسعار.
                ...
                <div class="mt-5">
                    ...
                    <p class="px-2">قد يتم تسجيل المكالمات الهاتفية إلى Mwakeb.Com لتمكيننا من مراقبة خدماتنا وتحسينها.
                        يرجى الاتصال بنا على info@Mwakeb.Com إذا كنت لا ترغب في تلقي أي رسائل بريد إلكتروني ترويجية / رسائل إخبارية أو عروض خاصة.
                        لن يكون Mwakeb.Com مسؤولاً عن أي فشل في الخدمة يتعلق بظروف لا يمكن السيطرة عليها مثل الفيضانات والزلازل، وأفعال الحكومات أو تغيير السلطة في بلد ما، والظروف الجوية السيئة، وما إلى ذلك.
                        قد تؤثر الاختلافات المناخية وقواعد توفير الطاقة في مختلف البلدان على أنظمة التدفئة في الفندق الذي يقع في تلك المنطقة و / أو البلد المعين. على سبيل المثال، في إيطاليا، لا يمكن تشغيل نظام التدفئة إلا بين 15 نوفمبر و15 مارس بسبب اللوائح الحكومية. قد تتأثر مواعيد افتتاح وإغلاق حمامات السباحة أيضًا بالمناخ والظروف الجوية. Mwakeb.Com غير مسؤول عن ممارسات الفنادق فيما يتعلق بهذه القضايا.
                        التحويلات
                        ...
                        5.Mwakeb.Com لن يتحمل أي مسؤولية عن السهو والأخطاء المطبعية التي قد تؤدي إلى أي انقطاع في الخدمة.
                        هام - عندما يكمل عضو Mwakeb.Com الحجز عبر الإنترنت، يجب عليه التحقق والتأكد من صحة جميع التفاصيل الموجودة في قسيمة الإقامة المدفوعة مسبقًا (مثل عنوان الفندق ومعلومات الفندق وتفاصيل المدينة والبلد).
                        يخضع استخدام موقع Mwakeb.Com لموافقتك على الشروط والأحكام الخاصة بنا. إذا كنت لا تقبل هذه الشروط والأحكام، يجب عليك الامتناع عن استخدام الموقع.
