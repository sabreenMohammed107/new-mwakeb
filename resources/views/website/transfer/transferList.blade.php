                            ...
                            <div class="card-body  setted_info">
                                ...
                                <div class="card_info">
                                    <p style="margin-bottom:0"> <i style="padding: 0 5px 0 5px;"
                                            ...
                                            href=""
                                            style="color:#1C4482;font-weight: 700">{{ $HRec->locationFrom->location_enname ?? '' }}
                                        </a></p>
                                    <span>
                                        <p style="margin-bottom:0"> <i style="padding: 0 5px 0 0;"
                                                class="fa-solid fa-suitcase-rolling"></i> {{ __('links.to') }} : <a
                                                href=""
                                                style="color:#1C4482;font-weight: 700">{{ $HRec->locationTo->location_enname ?? '' }}</a>
                                        </p>
                                    </span>
                                </div>
                                ...
                                <form action="{{ LaravelLocalization::localizeUrl('/bookTransfer') }}" method="POST">
                                    ...
                                    <div class="booking_info">
                                        ...
                                        <div class="details px-1">
                                            ...
                                            <input type="text" id="transfer_date" class="form-control transfer_date "
                                                name="transfer_date" />
                            ...
                            <div class="card-body  setted_info">
                                ...
                                <div class="card_info">
                                    <p style="margin-bottom:0"> <i style="padding: 0 5px 0 5px;"
                                            class="fa-solid fa-suitcase-rolling"></i>{{ __('links.from') }} : <a
                                            href=""
                                            style="color:#1C4482;font-weight: 700">{{ $HPrice->locationFrom->location_enname ?? '' }}
                                        </a></p>
                                    <span>
                                        <p style="margin-bottom:0"> <i style="padding: 0 5px 0 0;"
                                                class="fa-solid fa-suitcase-rolling"></i> {{ __('links.to') }} : <a
                                                href=""
                                                style="color:#1C4482;font-weight: 700">{{ $HPrice->locationTo->location_enname ?? '' }}</a>
                                        </p>
                                    </span>
                                </div>
                            ...
                            <div class="card-body  setted_info">
                                ...
                                <div class="card_info">
                                    <p style="margin-bottom:0"> <i style="padding: 0 5px 0 5px;"
                                            class="fa-solid fa-suitcase-rolling"></i>{{ __('links.from') }} : <a
                                            href=""
                                            style="color:#1C4482;font-weight: 700">{{ $HAlpha->locationFrom->location_enname ?? '' }}
                                        </a></p>
                                    <span>
                                        <p style="margin-bottom:0"> <i style="padding: 0 5px 0 0;"
                                                class="fa-solid fa-suitcase-rolling"></i> {{ __('links.to') }} : <a
                                                href=""
                                                style="color:#1C4482;font-weight: 700">{{ $HAlpha->locationTo->location_enname ?? '' }}</a>
                                        </p>
                                    </span>
                                </div>
